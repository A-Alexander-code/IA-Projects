...
if __name__=='__main__':
    ...
    # Initializae the pygame mixer
    pygame.mixer.init()
    
    # Path of the sound file
    sound_file_1='Sound/Message Notification 01.mp3'
    sound_file_2='Sound/Message Notification 02.mp3'
    ...
    while True:
        ...
        # Take 60 face samples and stop video. You may increase or decrease the number of
